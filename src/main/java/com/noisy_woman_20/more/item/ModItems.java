...
public class ModItems {
	...
	public static final Item DIAMOND_SWORD = ToolRegisterFunctions.registerItem(
		"diamond_sword",
		new DiamondSwordItem()
	);

	public static final Item MUSIC_DISC_MINECRAFT = ToolRegisterFunctions.registerItem(
		"music_disc_minecraft",
		new MusicDiscMinecraftItem()
	);

	public static final Item MUSIC_DISC_INFINITE_AMETHYST = ToolRegisterFunctions.registerItem(
		"music_disc_infinite_amethyst",
		new MusicDiscInfiniteAmethystItem()
	);

	public static final Item MUSIC_DISC_PRECIPICE = ToolRegisterFunctions.registerItem(
		"music_disc_precipice",
		new MusicDiscPrecipiceItem()
	);

	public static final Item MUSIC_DISC_CREATOR = ToolRegisterFunctions.registerItem(
		"music_disc_creator",
		new MusicDiscCreatorItem()
	);

	public static final Item MUSIC_DISC_CREATOR_MUSIC_BOX = ToolRegisterFunctions.registerItem(
		"music_disc_creator_music_box",
		new MusicDiscCreatorMusicBoxItem()
	);

	public static final Item GRASS_BLOCK = ToolRegisterFunctions.registerItem(
		"grass_block",
		new GrassBlockItem()
	);

	public static final Item GLOWING_OBSIDIAN = ToolRegisterFunctions.registerItem(
		"glowing_obsidian",
		new GlowingObsidianBlockItem()
	);

	public static final Item REACTOR_CORE_STAGE = ToolRegisterFunctions.registerItem(
		"reactor_core_stage",
		new ReactorCoreStageBlockItem()
	);

	public static final Item NETHER_PORTAL = ToolRegisterFunctions.registerItem(
		"nether_portal",
		new NetherPortalBlockItem()
	);

	public static final Item END_PORTAL = ToolRegisterFunctions.registerItem(
		"end_portal",
		new EndPortalBlockItem()
	);

	public static final Item END_GATEWAY = ToolRegisterFunctions.registerItem(
		"end_gateway",
		new EndGatewayBlockItem()
	);

	public static final Item FROSTED_ICE = ToolRegisterFunctions.registerItem(
		"frosted_ice",
		new FrostedIceBlockItem()
	);

	public static final Item POWDER_SNOW = ToolRegisterFunctions.registerItem(
		"powder_snow",
		new PowderSnowBlockItem()
	);

	public static final Item FIRE = ToolRegisterFunctions.registerItem(
		"fire",
		new FireBlockItem()
	);

	public static final Item SOUL_FIRE = ToolRegisterFunctions.registerItem(
		"soul_fire",
		new SoulFireBlockItem()
	);

	public static final Item WATER_BLOCK = ToolRegisterFunctions.registerItem(
		"water",
		new WaterItem()
	);

	public static final Item LAVA_BLOCK = ToolRegisterFunctions.registerItem(
		"lava",
		new LavaItem()
	);

	public static final Item SPAWNER_MINECART = ToolRegisterFunctions.registerItem(
		"spawner_minecart",
		new SpawnerMinecartItem()
	);

	public static final Item TOTEM_OF_DYING = ToolRegisterFunctions.registerItem(
		"totem_of_dying",
